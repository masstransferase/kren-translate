...
Rewrite English sends the exact submitted English text plus fixed, provider-independent rewriting rules. It does not attach surrounding editor or chat context. The three-variant operation requests Natural English, Concise, and Jargon-Free results; direct operations request only the selected variant.
