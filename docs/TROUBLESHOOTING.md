...
- **Dictionary key rejected or no entry found:** confirm that each Merriam-Webster key was issued for the matching reference. Collegiate Dictionary, Collegiate Thesaurus, and Medical Dictionary use separate credential fields. A key for one reference does not unlock another.
