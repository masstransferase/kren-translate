...
5. Smoke-test English Dictionary, Synonyms, Korean Dictionary, Translation, Explain Nuance, Rewrite English, and supported Read Aloud modes with user-owned restricted test keys.
