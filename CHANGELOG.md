...
- Fixes the Merriam-Webster credential panel comparing against its own copy of the key limit instead of the shared constant, which let the panel refuse a key while announcing a different limit.
